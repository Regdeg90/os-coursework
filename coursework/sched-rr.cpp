...
class RoundRobinScheduler : public SchedulingAlgorithm
{
  public:
	...
	SchedulingEntity *pick_next_entity() override
	{
		...
		//Sends the next eligible entry to the back of the queue and returns it
		SchedulingEntity * nextentity = runqueue.pop();
		runqueue.append(&*nextentity);
